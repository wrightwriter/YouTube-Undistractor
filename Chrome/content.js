...
//       chrome.storage.sync.get(input, item => {
//         callback(item);
//       });
//     },
//     setValue: (input, value) => {
//         console.log(input);
//       chrome.storage.sync.set({[ input ]: value}, () => {
//         alert("set sucess", input, value);
//         alert( value);
//       });
//     },
//   };
  ...
  async function onMouseDown(button) {
    GM.getValue("distractionsAreDisabled", value => {
      distractionsAreDisabled = value;
    });
  ...
  function enableDistractions() {
    GM.setValue("distractionsAreDisabled", false);
    location.reload();
  }
  // ------------------- INIT ---------------------- //
  window.onload = async e => {
    distractionsAreDisabled = false;
    GM.getValue("distractionsAreDisabled", value => {
      if (value) {
        // alert(value);
        distractionsAreDisabled = value;
